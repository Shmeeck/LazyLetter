from CoverLetterExpress import filter_answer
...
def test_each_letter():
    ...
    test_list = ['i like caake', 'Test Bakery',
                 ...
                 '']
    result = filter_answer.each_letter(test_list, 'a')
    ...
    result = filter_answer.each_letter(test_list, 'WAFF')
    assert_equals('WAFFLES', result[0])

    result = filter_answer.each_letter(test_list, 'who put this here')
    assert_equals('who put this here', result[0])

    result = filter_answer.each_letter(test_list, 'el')
...
def test_entire_string():
    ...
    * spaces count
    ...
    test_list = ['I like stripes', 'Stripes are what I like',
                 ...
                 'I like pie', 'LIKE']
    # --- 1 ---
    assert_equals(filter_answer.entire_string(test_list, 'sTrIpEs'),
                  [test_list[0], test_list[1], test_list[2],
                   ])
    assert_equals(filter_answer.entire_string(test_list, 'sTRiPES stripES'),
                  [test_list[2]])

    # --- 2 ---
    assert_equals(filter_answer.entire_string(test_list, 'Pie is greater'),
                  [])

    # --- 3 ---
    assert_equals(filter_answer.entire_string(test_list, 'like'),
                  [test_list[5]])
...
def test_index():
    ...
    # --- 1 ---
    assert_equals(filter_answer.index(test_list, 2), [test_list[1]])

    # --- 2 ---
    assert_equals(filter_answer.index(test_list, 'pie'), None)

    # --- 3 ---
    assert_equals(filter_answer.index(test_list, -99), [])
    assert_equals(filter_answer.index(test_list, 1029392), [])
...
def test_everything():
    ...
    # --- 1 ---
    assert_equals(filter_answer.everything(test_list, 'gENe'), [test_list[0]])
    assert_equals(filter_answer.everything(test_list, '2'), [test_list[1]])

    # --- 2 ---
    assert_equals(filter_answer.everything(test_list, 'setq'), [])
    assert_equals(filter_answer.everything(test_list, '6'), [])

    # --- 3 ---
    assert_equals(filter_answer.everything(test_list, 'I'), [test_list[1],
                                                             test_list[2],
                                                             test_list[3],
                                                             test_list[4]
                                                             ])
    ...
    # --- 4 ---
    assert_equals(filter_answer.everything(test_list, 'EAT'), [test_list[3]])

    # --- 5 ---
    assert_equals(filter_answer.everything(test_list, 'exit'), [test_list[2]])
